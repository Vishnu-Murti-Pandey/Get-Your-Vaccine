...
import com.example.getyourvaccine.databinding.ItemListBinding

class VaccineSlotAdapter(private val listener: VaccineItemClicked) : RecyclerView.Adapter<VaccineSlotAdapter.VaccineViewHolder>() {

    private val items: ArrayList<Vaccine> = ArrayList()

    class VaccineViewHolder(val binding: ItemListBinding) : RecyclerView.ViewHolder(binding.root)
