...
import com.example.getyourvaccine.databinding.VaccineSlotsBinding
...
class VaccineSlots: AppCompatActivity(), VaccineItemClicked{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vaccineURL = "https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/calendarByPin?pincode=$postalCode&date=$date"
